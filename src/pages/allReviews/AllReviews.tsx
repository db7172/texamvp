...
import dp from "../../assets/png/profile2.png";
...
const dummyData = [
  {
    ...
    star: 5,
    comment:
      "Our marketing site is built on texatrove now. Makes it easier to update, especially for He said all new portcos build their marketing sites in @texatrove. ",
    place: "Bhutan",
    date: "June 2020",
  },
  {
...
const AllReviews = () => {
  const [reviewData, setReviewData] = useState(dummyData.slice(0, 6));
  const [showLoadMoreButton, setShowLoadMoreButton] = useState(true);

  const handleClick = () => {
    const currentCount = reviewData.length;

    if (currentCount < dummyData.length) {
      setReviewData(dummyData.slice(0, currentCount + 4));
    } else {
