...
const accomodationPanes = [
  {
    title: "Day 1",
    Content: AccomodationFormTab,
    key: "day1",
    closable: false,
  },
  { title: "Day 2", Content: AccomodationFormTab, key: "day2" },
];
...
const transpotationPanes = [
  ...
  { title: "Day 2", Content: TranspotationFormTab, key: "day2" },
];
          ...
          <Row>
            <Col span={18} className="tw-p-8 tw-shadow-card">
              ...
              >
                ...
                <Form.Item label="Rate Per Person" className="tw-flex">
                  <div className="tw-w-full tw-flex tw-items-center tw-gap-2 tw-mb-5">
                    <Form.Item
                      name="paymentRatePerPersonFirstField"
                ...
                <Form.Item label="Places You Want to Include">
                  <Form.Item extra={<p>* You can include upto 5 places</p>}>
                    <Input
                      value={tagInput}
